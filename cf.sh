...
echo "https://raw.githubusercontent.com/djiejeowmwowmwo/ndwqkdnqwkjdnqwdj/main/colo Save as colo.txt"
echo "https://raw.githubusercontent.com/djiejeowmwowmwo/ndwqkdnqwkjdnqwdj/main/url Save as url.txt"
echo "https://raw.githubusercontent.com/djiejeowmwowmwo/ndwqkdnqwkjdnqwdj/main/ipv4 Save as ips-v4.txt"
echo "https://raw.githubusercontent.com/djiejeowmwowmwo/ndwqkdnqwkjdnqwdj/main/ipv6 Save as ips-v6.txt"
echo "https://raw.githubusercontent.com/djiejeowmwowmwo/ndwqkdnqwkjdnqwdj/main/domains Save as domain.txt"
while true
do
	if [ ! -f "colo.txt" ]
	then
		echo "Download data center information from server colo.txt"
		curl --retry 2 -s https://raw.githubusercontent.com/djiejeowmwowmwo/ndwqkdnqwkjdnqwdj/main/colo -o colo.txt
	elif [ ! -f "url.txt" ]
	then
		echo "Download the speed test file address from the server url.txt"
		curl --retry 2 -s https://raw.githubusercontent.com/djiejeowmwowmwo/ndwqkdnqwkjdnqwdj/main/url -o url.txt
	elif [ ! -f "ips-v4.txt" ]
	then
		echo "Download IPV4 data from server ips-v4.txt"
		curl --retry 2 -s https://raw.githubusercontent.com/djiejeowmwowmwo/ndwqkdnqwkjdnqwdj/main/ipv4 -o ips-v4.txt
	elif [ ! -f "ips-v6.txt" ]
	then
		echo "Download IPV6 data from server ips-v6.txt"
		curl --retry 2 -s https://raw.githubusercontent.com/djiejeowmwowmwo/ndwqkdnqwkjdnqwdj/main/ipv6 -o ips-v6.txt
	elif [ ! -f "domain.txt" ]
	then
		echo "Download domain data from server domain.txt"
		curl --retry 2 -s https://raw.githubusercontent.com/djiejeowmwowmwo/ndwqkdnqwkjdnqwdj/main/domains -o domain.txt
	else
		break
	fi
done
...
do
	...
	echo "8. update data"
	echo "9. domain preferred(TLS)"
	echo "10. domain preferred"
	echo -e "0. quit\n"
